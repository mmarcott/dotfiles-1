...
let g:airline#themes#papercolor#palette.normal_modified = {
      \ 'airline_c': [ '#eeeeee' , '#005f87' , 197 , 24 , '' ] ,
      \ }


" Insert Mode:
let s:I1 = [ '#585858' , '#e4e4e4' , 240 , 43  ] " Mode
let s:I2 = [ '#e4e4e4' , '#0087af' , 254 , 31  ] " Info
let s:I3 = [ '#eeeeee' , '#005f87' , 255 , 43  ] " StatusLine
...
let g:airline#themes#papercolor#palette.insert_modified = {
      \ 'airline_c': [ '#eeeeee' , '#005f87' , 197 , 43 , '' ] ,
      \ }
...
" Visual Mode:
let s:V1 = [ '#005f87', '#e4e4e4', 254,  54 ]
let s:V2 = [ '',        '#0087af', '',  31  ]
let s:V3 = [ '#e4e4e4', '#005f87', 254, 54 ]
...
let g:airline#themes#papercolor#palette.visual_modified = {
      \ 'airline_c': [ '#e4e4e4', '#005f87', 197, 24  ] ,
      \ }
...
let g:airline#themes#papercolor#palette.inactive_modified = {
      \ 'airline_c': [ '#585858' , '#e4e4e4' , 197 , 254 , '' ] ,
      \ }
